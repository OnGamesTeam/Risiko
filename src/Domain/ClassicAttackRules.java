...
public class ClassicAttackRules implements AttackRule {
	...
	public List<Territory> calculateAttackingTerritory(Map map, String playerID) {
		List<Territory> playerTerritory = map.getPlayerTerritories(playerID);
		List<Territory> attackingTerritory = new ArrayList<Territory>();
	...
	public List<Territory> calculateAttackableTerritory(Map map, String attackingTerritoryName) {
